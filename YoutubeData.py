...
with col1:
    ...
    Get_data = st.button('**Export To MongoDB**')
        ...
        def get_channel_data(youtube,channel_id):
            try:
                try:
                    ...
                    st.error('Server Error or Check your connectivity or Try again later')
...
Check_channel = st.checkbox('**Check Available Channels**')
